...
let total = 0;
//Variavel para armazenar o valor total dos produtos.

//Elementos de manipulação do DOM - CONST É UMA VARIAVEL QUE NAO PODE SER ALTERADO.
...
const tbody = tabela.querySelector("tbody"); //SELECTOR VAI INSERIR LINHAS **
...
document.getElementById("adicionar").addEventListener("click", function() {
    ...
    //Converter o valor do campo para um número de ponto flutuante

    //Verifica se o nome do produto foi preenchido, se o valor é numero e positivo.
     if (nomeProduto && !isNaN(valorProduto)&& valorProduto >0) {
        ...
        alert ("Por favor, insira um nome de produto válido e um valor númerico positivo.");
     }
    });

    //Função para exibir a tabela com os produtos
    document.getElementById("vizualizarTabela").addEventListener("click", function()
{
    //Limpa o conteúdo atual da tabela para evitar duplicações.
    tbody.innerHTML = '';

    //Intera sobre o array de produtos e adiciona uma linha para cada produto na tabela
    produtos.forEach(function (produto) {
        ...
        valorCell.tectContent = "R$" + produto.valor.toFixed (2); //Formata o valor do produto com duas casas decimais
    ...
    //Atualiza o valor total no rodapé na tabela, também formatado com duas casas decimais. 
